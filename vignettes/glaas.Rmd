...
The full dataset is available directly after loading the `glass`. No need to call `data("glaas")`! This package uses [lazy loading](https://journal.r-project.org/articles/RN-2004-009/RN-2004-009.pdf), which means the dataset is only loaded into memory when you actually use it. This keeps the package lightweight.
